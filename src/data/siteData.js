...
export const resultados = [
  ...
  },
  {
    ...
    resultado: "+20KG DE MASSA MUSCULAR",
    descricao: "em 2 anos e 6 meses de acompanhamento",
    formato: "Acompanhamento presencial",
...
export const planos = [
  {
    ...
    mensagemWhatsapp:
      "Olá, Matheus! Vim pelo seu site e tenho interesse no Plano Online Básico. Quero começar com um treino personalizado. Pode me explicar como funciona o acompanhamento e quais são os próximos passos?",
    destaque: "basic",
  },
  {
    numero: "02",
    ...
    beneficios: [
      ...
      "Feedbacks semanais",
      "Ajustes mensais",
      "Orientação para adaptação da rotina",
    ...
    mensagemWhatsapp:
      "Olá, Matheus! Vim pelo seu site e tenho interesse no Plano Online Intermediário. Quero alinhar treino e alimentação para acelerar meus resultados. Pode me explicar como funciona o acompanhamento e quais são os próximos passos?",
    destaque: "intermediate",
  },
  {
    numero: "03",
    ...
    beneficios: [
      ...
      "Avaliação por fotos",
      "Plano alimentar personalizado",
      "Monitoramento detalhado da evolução",
      "Feedbacks semanais",
      ...
      "Revisão completa de treino e alimentação",
    ...
    mensagemWhatsapp:
      "Olá, Matheus! Vim pelo seu site e tenho interesse no Plano Online Premium. Busco uma experiência mais completa, com avaliações presenciais e acompanhamento mais próximo. Pode me explicar como funciona e quais são os próximos passos?",
    destaque: "popular",
  },
];
